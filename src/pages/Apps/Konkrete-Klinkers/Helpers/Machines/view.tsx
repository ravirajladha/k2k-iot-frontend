...
const Machines = () => {
    ...
    const cols = [
        ...
        { accessor: 'plant_name', title: 'Plant Name' },
        // { accessor: 'factory_name', title: 'Factory Name' },
        { accessor: 'machine_name', title: 'Machine Name' },
        { accessor: 'status', title: 'Status' },
        { accessor: 'created_by', title: 'Created By' },
        {
            accessor: 'created_at',
            title: 'Created At',
            // render: ({ created_at }) => <div>{new Date(created_at).toLocaleDateString()}</div>, // Formatting date
        },
    ];
    ...
    return (
        <div>
            ...
            <Breadcrumbs
                ...
                addButton={{
                    label: 'Add Machine', link: '/konkrete-klinkers/machines/create',
            ...
            <div className="panel mt-6">
                <div className="flex md:items-center md:flex-row flex-col mb-5 gap-5">
                    <h5 className="font-semibold text-lg dark:text-white-light">Machines</h5>
                    ...
                    <DataTable
                        ...
                        columns={[
                            ...
                            },
                            {
                                ...
                                title: 'Machine Name',
                                sortable: true,
                                hidden: hideCols.includes('machine_name'),
                            },
                            {
                                accessor: 'plant_name',
                                title: 'Plant Name',
                                sortable: true,
                                hidden: hideCols.includes('plant_name'),
                            },
                            // {

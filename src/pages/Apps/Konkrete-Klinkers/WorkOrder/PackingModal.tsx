                  ...
                  <div className="mt-4 space-y-4">
                    ...
                    <div>
                      ...
                      <p>
                        ...
                        <span className={`px-2 py-1 rounded-md ${statusColors[data?.status] || "bg-gray-500"}`}>
                          {data?.status}
                        </span>
                      </p>
                    ...
                    <table className="min-w-full table-auto">
                      <thead>
                        <tr className="bg-gray-100 text-left">
                          ...
                          <th className="p-2 font-semibold">Batch ID</th>
                        ...
                        {data?.products?.flatMap((product) =>
                          product.semiFinishedProducts.map((sf, index) => (
                            <tr key={index}>
                              ...
                              <td className="p-2">{sf.sfId}</td>
                              <td className="p-2">
                                {sf.qrCodes.map((qrCode, qrIndex) => (
                                  <span key={qrIndex} className="inline-block bg-gray-200 text-gray-800 px-2 py-1 rounded-md m-1">
                                    {qrCode}
                                  </span>
                                ))}
                              </td>

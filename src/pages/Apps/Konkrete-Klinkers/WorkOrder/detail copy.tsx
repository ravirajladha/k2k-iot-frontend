      ...
      {showModal && selectedProduct && (
                <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
                    <div className="bg-white p-6 rounded-lg shadow-lg w-1/3">
                        <h3 className="text-lg font-semibold mb-4">{selectedProduct.description} - Dimensions</h3>
                        <table className="w-full border-collapse border border-gray-300">
                            ...
                            <tbody>
                                {selectedProduct.dimensions.map((dim, index) => (
                                    <tr key={index} className="hover:bg-gray-50">
                                        <td className="px-4 py-2 border border-gray-300">{dim.name}</td>
                                        <td className="px-4 py-2 border border-gray-300">{dim.value}</td>
                                    </tr>
                                ))}
                            </tbody>
                        </table>

...
import { fetchProductByJobOrder, fetchQcById, storeQcData } from '@/api/konkreteKlinkers/qc';
...
const QcUpdateForm = () => {
    ...
    useEffect(() => {
        dispatch(setPageTitle('Qc Update'));
    });
            ...
            try {
                ...
                if (id) {
                    ...
                    reset({
                        ...
                        workOrder: data.work_order._id || '',
                        productId: data.product_id._id || '',
                        rejectedQuantity: data.rejected_quantity || '',
                        recycledQuantity: data.recycled_quantity || '',
    ...
    const onSubmit = async (data: FormValues) => {
        ...
        try {
            ...
            setApiError(error.response?.data?.message || 'Failed to update product. Please try again.');
        }
    };

...
const DispatchCreation = () => {
    ...
    const [items, setItems] = useState<any>([{ id: 1, title: 'Product 1', uom: 'Nos', dispatchQuantity: 0, plannedQuantity: 0, achievedQuantity: 0, rejectedQuantity: 0, recycledQuantity: 0 }]);

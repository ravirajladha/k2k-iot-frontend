                            ...
                            <div>
                                ...
                                <table className="w-full text-xs text-left text-gray-600 dark:text-gray-300">
                                    <tbody>
                                        ...
                                        <tr><td className="font-semibold text-green-600">Planned Quantity:</td> <td>{report.plannedQuantity}</td></tr>
                                        <tr><td className="font-semibold text-green-600">Achieved:</td> <td>{report.achievedTillNow}</td></tr>
                                        <tr><td className="font-semibold text-green-600">Balance:</td> <td>{report.balancedQuantity}</td></tr>

...
const ProjectCreation = () => {
  ...
  const breadcrumbItems = [
    ...
    { label: 'Machines', link: '/iron-smith/machines', isActive: false },
  ...
  return (
    <div>
      <Breadcrumbs
        ...
        addButton={{ label: 'Back', link: '/iron-smith/machines', icon: <IconArrowBackward className="text-4xl" /> }}
      />
      <div className="panel">
        <div className="mb-5">
...
::contentReference[oaicite:0]{index=0}
          ...
          <div className="flex justify-between space-x-4 mt-6">
            ...
            {/* Cancel Button */}
            <Link to="/iron-smith/machines" className="flex-1">

...
//     // Placeholder logo URL (replace with actual path)
//     const logoUrl = 'https://via.placeholder.com/100x30?text=IronSmith+Logo'; // Replace with correct logo path
...
//                             <div
//                                 key={cardNumber}
//                                 className="product-card bg-white border border-gray-800 p-1 flex flex-col w-[30rem] overflow-hidden relative"
//                                 style={{ height: '260px' }}
//                             >
//                                 {/* Logo in the top-left corner */}
//                                 <div className="logo absolute left-0 top-0 p-1">
//                                     <img src={logo} alt="Logo" className="w-30 h-7 mb-4" />
//                                 </div>

//                                 {/* S.No in the top-right corner */}

...
const ColumnChooser = () => {
    ...
    const breadcrumbItems = [
        ...
        { label: 'Work Order', link: '/iron-smith/work-order/view', isActive: true },
    ];
    ...
    return (
        <div>
            ...
            <Breadcrumbs
                ...
                addButton={{
                    label: 'Add Work Order', link: '/iron-smith/work-order/create',
...

                            {
                                ...
                                render: ({ id }) => (
                                    <div className="flex gap-4 items-center w-max mx-auto">
                                        {/* <NavLink to={`/iron-smith/work-order/create`} className="flex hover:text-info">
                                            <IconEdit className="w-4.5 h-4.5" />
                                        </NavLink> */}
                                        <NavLink to={`/iron-smith/work-order/detail`} className="flex hover:text-primary">
                                            <IconEye />
                                        </NavLink>
                                    </div>
                                ),

...
const Plants = () => {
    ...
    const cols = [
        ...
        { accessor: 'client', title: 'Plant Name' },
    ...
    const breadcrumbItems = [
        ...
        { label: 'Plants', link: '/falcon-facade/plants', isActive: true },
    ];
    ...
    return (
        <div>
            ...
            <Breadcrumbs
                ...
                addButton={{
                    label: 'Add Plant', link: '/falcon-facade/plants/create',
            ...
            <div className="panel mt-6">
                <div className="flex md:items-center md:flex-row flex-col mb-5 gap-5">
                    <h5 className="font-semibold text-lg dark:text-white-light">Plants</h5>

    ...
    <div>
      ...
      <div className="panel">
        <div className="flex justify-between items-start flex-wrap gap-4 px-4">
          ...
          <div className="flex flex-col space-y-2">
            <p><strong>Work Order:</strong> {dispatchData.workOrderNumber}</p>
            <p><strong>Client:</strong> {dispatchData.clientName}</p>
            <p><strong>Project:</strong> {dispatchData.projectName}</p>
            <p><strong>Invoice/Order:</strong> {dispatchData.invoiceSto}</p>
            <p><strong>Vehicle Number:</strong> {dispatchData.vehicleNumber}</p>
          </div>
        </div>

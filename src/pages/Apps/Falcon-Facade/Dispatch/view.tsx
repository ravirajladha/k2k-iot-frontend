...
const rowData = [
    ...
    },
    {
        ...
        products: [
            ...
            { productId: 'Fixed Type2', quantity: 3 },
        ],
        invoiceNo: 'INV123458',
        rejectedQuantity: "22",
...
const ColumnChooser = () => {
    ...
    const breadcrumbItems = [
        ...
        { label: 'Dispatch', link: '/falcon-facade/dispatch/view', isActive: true },
      ];
 ...
 useEffect(() => {
  ...
  <Breadcrumbs
        ...
        addButton={{ label: 'Add Dispatch', link: '/falcon-facade/dispatch/create',
                            ...
                            },
                            {
                                ...
                                render: ({ sl_no }) => (
                                    <div className="flex gap-4 items-center w-max mx-auto">
                                        ...
                                        <NavLink to={`/falcon-facade/dispatch/challan`} className="flex hover:text-primary">

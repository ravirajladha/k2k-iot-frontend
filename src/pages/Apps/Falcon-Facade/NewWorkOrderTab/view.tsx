...
const rowData = [
    {
        ...
        remarks: 'Should be created within given time',
...
const ColumnChooser = () => {
    ...
    const breadcrumbItems = [
        ...
        { label: 'Work Order', link: '/falcon-facade/work-orders/', isActive: true },
    ];
        ...
        <div>
            <Breadcrumbs
                ...
                addButton={{
                    ...
                    link: '/falcon-facade/work-orders/create',
...

                            {
                                ...
                                render: ({ id }) => (
                                    <div className="flex gap-4 items-center w-max mx-auto">
                                        ...
                                        <NavLink to={`/falcon-facade/work-orders/detail`} className="flex hover:text-primary">
                                            <IconEye />
                                        </NavLink>
                                    </div>
                                ),

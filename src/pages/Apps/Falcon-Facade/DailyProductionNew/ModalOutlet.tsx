...
export const ModalOutlet: React.FC<ModalOutletProps> = ({ 
  isOpen, 
  closeModal, 
  type, 
  data 
              ...
              <div className="fixed inset-0 overflow-y-auto flex justify-center items-start p-4">
                  ...
                  >
                      <Dialog.Panel className="bg-white dark:bg-gray-800 rounded-lg max-w-lg w-full shadow-lg">
                          ...
                          {type === "updateCompletedQuantity" && (
                              <UpdateCompletedQuantityModal 
                                  isOpen={isOpen} 
                                  setShowUpdateModal={closeModal} 
                                  data={data} 
                              />
                          )}
                          {type === "qcCheck" && (
